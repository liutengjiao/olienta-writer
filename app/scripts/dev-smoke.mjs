...
const sourceContracts = [
  ...
  },
  {
    ...
    includes: ['章节任务书', 'writingBriefPath', 'onSaveModuleMarkdownFile', '取消生成', '上下文窗口', '最大输出', '超时秒数', '调用次数', '平均耗时', 'Token 总量', '导出', '选中章节', 'exportSelected', '模型调用', 'PROVIDER_USE_CASES', '导出 JSON', '导入 JSON', 'skill-meta-row', 'formatSkillCategory', 'formatSkillTag', 'buildProviderExportJson', '导出 JSON 默认不包含密钥'],
  },
  {
